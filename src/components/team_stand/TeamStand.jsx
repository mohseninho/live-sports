...
import {data} from "../../data/teams/teams"
    ...
    return(
        <div className={style.wrapper}>
            ...
            <div className={style.teamResult}>
                ...
                <p className={style.gd}>{team.result[4] - team.result[5]}</p>
                <p className={style.pts}>{team.result[1] * 3 + team.result[2] }</p>
            </div>
        </div>
    )
}
